...
Page({
  ...
  formSubmit: function (e) {
    ...
    var xm = e.detail.value.xm, sjh = e.detail.value.sjh, yanzm = e.detail.value.yanzm, sr = e.detail.value.sr, xxdz = e.detail.value.xxdz, xtxx = this.data.xtxx;
    console.log(xm, sjh, yanzm, sr, xxdz, xtxx,openid)
    var warn = "";//弹框时提示的内容
    ...
    app.util.request({
      ...
      success: function (res) {
        ...
        wx.setNavigationBarTitle({
          title: res.data.link_name + '会员卡注册',
        })
      }
    });
    //取imglink
