...
Page({
  ...
  topjumps: function (e) {
    ...
    var src = e.currentTarget.dataset.src, src2 = e.currentTarget.dataset.websrc
    ...
    app.util.request({
      ...
      success: function (res) {
        ...
        app.getUserInfo(function (userInfo) {
          ...
          console.log('scene', scene, wx.getStorageSync('mdid'))
          if (scene != 'undefined') {
            that.StoreInfo(scene)
          }
          else if (wx.getStorageSync('mdid') != '') {
            that.StoreInfo(wx.getStorageSync('mdid'))
          }
          else {
